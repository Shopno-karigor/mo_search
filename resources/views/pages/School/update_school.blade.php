@extends('master')
@section('editSchool')
  <title>BusTech OMS | Edit School</title>
</head>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('school-list')}}">School List</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('post_code') is-invalid @enderror" value="{{$data[0]->post_code}}" name="post_code" required>
                                @error('post_code')
                                  <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control @error('school_code') is-invalid @enderror" value="{{$data[0]->school_code}}" name="school_code" required>
                              @error('school_code')
                                <p class="text-danger">{{ $message }}</p>
                              @enderror
                            </div>
