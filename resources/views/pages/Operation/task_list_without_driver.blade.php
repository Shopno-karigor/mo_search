@extends('master')
@section('taskListWithoutDiver')
  <title>BusTech OMS | Pending Task List</title>
</head>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pending Task List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Pending Tasks</h3>
                    ...
                    @if (isset($data))
                      @foreach ($data as $key=>$row)
                        <tr>
                          ...
                          <td><a href="{{route('assign-driver',$row->booking_id)}}" class="btn btn-warning">Assign Driver</a></td>
